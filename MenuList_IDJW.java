...
public class MenuList_IDJW {
	...
	public void add(Restaurant_IDJW rest) {
		...
		// ***dynamic capacity ---> increase if capacity overflows
		if (isFull()) {
			moreCapacity();
		}
	...
	public void insertRestaurant(Restaurant_IDJW rest2, int position) {
		for (int f = indexOfNext; f >= position; f--) {
	...
	//Clears all objects from the restaurant array
	public void clear() {
	...
	public void moreCapacity() {
		...
		// Ex: capacity = 5 --> new capacity 5*1.5 = 7.5 -- round up --> NEW CAPACITY =
		// 8
